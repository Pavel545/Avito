                        ...
                        <div className="form-newArt__block">
                            ...
                            <div className="form-newArt__bar-img">
                                <div   className="form-newArt__img">
                                    ...
                                    <input className="input_file" onChange={e=>files(e,image1)} type="file" />
                                    <div  className="form-newArt__img-cover"></div>                                    
                                </div>
                                <div className="form-newArt__img">
                                    <img className="image_in" ref={image2} src="" alt=""/>
                                    <input className="input_file" onChange={e=>files(e,image2)} type="file" />
                                    <div  className="form-newArt__img-cover"></div>   
                                </div>
                                <div className="form-newArt__img">
                                    <img className="image_in" ref={image3} src="" alt=""/>
                                    <input className="input_file" onChange={e=>files(e,image3)} type="file" />
                                    <div  className="form-newArt__img-cover"></div>   
                                </div>
                                <div className="form-newArt__img">
                                    <img className="image_in" ref={image4} src="" alt=""/>
                                    <input className="input_file" onChange={e=>files(e,image4)} type="file" />
                                    <div  className="form-newArt__img-cover"></div>   
                                </div>
                                <div className="form-newArt__img">
                                    <img className="image_in" ref={image5} src="" alt=""/>
                                    <input className="input_file" onChange={e=>files(e,image5)} type="file" />
                                    <div  className="form-newArt__img-cover"></div>   
                                </div>
                            </div>
                        </div>
